$(function()
{
  ...
  function change_ExcitationPowerCtrl(){ExcitationPowerCtrl = bic;}
  function change_HighFrequencyPowerCtrl(){HighFrequencyPowerCtrl = hvdvc;}
  function change_HighFrequencyPowerOmigaCtrl(){HighFrequencyPowerOmigaCtrl = hvdvoc;}
  ...
  h.YBslider[1].valueChange(function(e,t,n)
  	                       {
  	                       	 ...
  	                       	 var m=$.YBslider
  	                       	   ...
  	                       	   ({
  	                       	 		...
  	                       	 		setValue:[0,100,10],
  	                       	 		showRange:!0,
  	                       	 		valueChange:function(e,t){bic=t,change_ExcitationPowerCtrl()}
  	                       	 	}),
  	                       	     HighFrequencyPowerCtrl_=$.YBslider
  	                       	   ({
  	                       	 		slidMain:"<span class='s-m' style='display:none' />",
  	                       	 		slidBar:"<i class='s-bar' />",slidBarBg:"<i class='s-b-b' />",
  	                       	 		slidBlock:"<a class='s-btn' href='javascript:;' />",
  	                       	 		...
  	                       	 		setValue:[0,100,10],
  	                       	 		showRange:!0,
  	                       	 		valueChange:function(e,t){hvdvc=t,change_HighFrequencyPowerCtrl()}
  	                       	 	}),
